...
-If a folder for a specific file type does not exist the script will automatically create a new folder and move the file into it. The script can be scheduled to run using Windows Task Scheduler allowing users to control when the script is run.
